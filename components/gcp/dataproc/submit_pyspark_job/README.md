...
2. Load the Kubeflow pipeline's SDK:
    ...
    dataproc_submit_pyspark_job_op = comp.load_component_from_url('https://raw.githubusercontent.com/kubeflow/pipelines/1.0.0-test-5/components/gcp/dataproc/submit_pyspark_job/component.yaml')
