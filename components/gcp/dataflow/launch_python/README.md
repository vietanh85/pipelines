...
2. Load the component using the Kubeflow pipeline's SDK:
    ...
    dataflow_python_op = comp.load_component_from_url('https://raw.githubusercontent.com/kubeflow/pipelines/1.0.0-test-5/components/gcp/dataflow/launch_python/component.yaml')
